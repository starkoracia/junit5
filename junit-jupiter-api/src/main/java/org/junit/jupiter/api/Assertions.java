...
public class Assertions {
	 ...
	 * list.
	 *
	 * <p>Find a detailed description of the matching algorithm here: {@linkplain #assertLinesMatch(List, List)}
	 *
	 ...
	 * {@code messageSupplier}. Fails with the supplied and the generated failure message.
	 *
	 * @see #assertLinesMatch(List, List)
	 */
	public static void assertLinesMatch(List<String> expectedLines, List<String> actualLines,
